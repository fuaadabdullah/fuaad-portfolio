...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-xs uppercase tracking-[0.15em] text-[var(--color-accent)] mb-3">{children}</p>
  );
}
  ...
  return (
    <article className="page-shell case-study">
      ...
      <header className="mb-14">
        <p className="text-xs uppercase tracking-[0.18em] text-[var(--color-accent)] mb-4">Flagship case study</p>
