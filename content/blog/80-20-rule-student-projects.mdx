...
**Result**: a focused tool I now use before every trade, plus steady usage from traders I've shared it with. Clean, focused, fast.

Read more about the lessons learned in [Building RIZZK](/blog/building-rizzk) or see the [full case study with screenshots](/portfolio/rizzk-calculator).
...
|---------|-------------|------|-------|
| RIZZK | Risk calculator | 4 weeks | In my daily workflow |
| My Portfolio | Project showcase | 1 week | Live |
| MVP Bootstrap Service | Template setup | 2 weeks | $2,400+ |

Want to see these projects in detail? Check out my [portfolio](/portfolio).
