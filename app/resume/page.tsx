...
export const metadata = {
  ...
  description:
    "Resume and profile for Fuaad Abdullah – B.B.A. finance graduate, full-stack developer, and independent day trader building practical software systems.",
  openGraph: {
    title: "Resume – Fuaad Abdullah",
    description:
      "Profile for recruiters and employers: finance background with hands-on software delivery across trading, web apps, and automation workflows.",
  ...
  return (
    <section className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
      <div className="space-y-2">
        ...
        <p className="text-sm text-zinc-300">{header.tagline}</p>
      </div>
