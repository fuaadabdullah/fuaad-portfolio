...
const mockResponses = {
  ...
  "projects": "A few projects: RIZZK Calculator (risk/position sizing), GoblinOS Assistant (multi-provider AI routing), Elbey Projects website (customer delivery), Gradem8 HF Space demo, ShopMindAI (automotive diagnostics), and this portfolio site. Ask about any one for details.",
  ...
  "shopmind": "ShopMindAI is an automotive diagnostic assistant built with FastAPI and deployed on Azure. It produces ranked likely causes and confirmatory tests from VIN, OBD codes, and symptom input. Canonical repo: github.com/fuaadabdullah/shopmind-ai.",
  "github": "Canonical repos are: fuaad-portfolio, rr-calculator, goblinos-assistant, marcus-website, gradem8-hf-space-2, and shopmind-ai.",
